...
namespace Itofinity.Bitbucket.Rest.Api
{
    ...
    public interface ISnippetsApi
    {
        ...
        /// <param name="role">Filter down the result based on the authenticated user&#39;s role (&#x60;owner&#x60;, &#x60;contributor&#x60;, or &#x60;member&#x60;). (optional)</param>
        /// <returns>Task of PaginatedSnippets</returns>
        [Get("/snippets")]
        System.Threading.Tasks.Task<PaginatedSnippets> SnippetsGet([Header("UserAgent")] string userAgent, [AliasAs("role")]string role = null);
        ...
        /// </remarks>
        /// <exception cref="Itofinity.Bitbucket.Rest.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="_body">The new snippet object.</param>
        /// <returns>Task of Snippet</returns>
        [Post("/snippets")]
        System.Threading.Tasks.Task<Snippet> SnippetsPost([Header("UserAgent")] string userAgent, [Body]Snippet _body);
        ...
        System.Threading.Tasks.Task SnippetsUsernameEncodedIdCommentsCommentIdDelete([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("comment_id")]string comment_id, [AliasAs("encoded_id")]string encoded_id);
        ...
        /// <param name="comment_id"></param>
        /// <param name="encoded_id"></param>
        /// <returns>Task of SnippetComment</returns>
        [Get("/snippets/{username}/{encoded_id}/comments/{comment_id}")]
        System.Threading.Tasks.Task<SnippetComment> SnippetsUsernameEncodedIdCommentsCommentIdGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("comment_id")]string comment_id, [AliasAs("encoded_id")]string encoded_id);
        ...
        System.Threading.Tasks.Task SnippetsUsernameEncodedIdCommentsCommentIdPut([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("comment_id")]string comment_id, [AliasAs("encoded_id")]string encoded_id);
        ...
        /// <param name="username"></param>
        /// <param name="encoded_id"></param>
        /// <returns>Task of PaginatedSnippetComments</returns>
        [Get("/snippets/{username}/{encoded_id}/comments")]
        System.Threading.Tasks.Task<PaginatedSnippetComments> SnippetsUsernameEncodedIdCommentsGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("encoded_id")]string encoded_id);
        ...
        /// <param name="username"></param>
        /// <param name="encoded_id"></param>
        /// <param name="_body">The contents of the new comment.</param>
        /// <returns>Task of Snippet</returns>
        [Post("/snippets/{username}/{encoded_id}/comments")]
        System.Threading.Tasks.Task<Snippet> SnippetsUsernameEncodedIdCommentsPost([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("encoded_id")]string encoded_id, [Body]Snippet _body);
        ...
        /// <param name="username"></param>
        /// <param name="encoded_id"></param>
        /// <returns>Task of PaginatedSnippetCommit</returns>
        [Get("/snippets/{username}/{encoded_id}/commits")]
        System.Threading.Tasks.Task<PaginatedSnippetCommit> SnippetsUsernameEncodedIdCommitsGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("encoded_id")]string encoded_id);
        ...
        /// <returns>Task of SnippetCommit</returns>
        [Get("/snippets/{username}/{encoded_id}/commits/{revision}")]
        System.Threading.Tasks.Task<SnippetCommit> SnippetsUsernameEncodedIdCommitsRevisionGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("encoded_id")]string encoded_id, [AliasAs("revision")]string revision);
        ...
        /// <exception cref="Itofinity.Bitbucket.Rest.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="username"></param>
        /// <param name="encoded_id">The snippet&#39;s id.</param>
        /// <returns>Task of void</returns>
        [Delete("/snippets/{username}/{encoded_id}")]
        System.Threading.Tasks.Task SnippetsUsernameEncodedIdDelete([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("encoded_id")]string encoded_id);
        ...
        System.Threading.Tasks.Task<Snippet> SnippetsUsernameEncodedIdGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("encoded_id")]string encoded_id);
        ...
        System.Threading.Tasks.Task SnippetsUsernameEncodedIdNodeIdDelete([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("node_id")]string node_id, [AliasAs("encoded_id")]string encoded_id);
        ...
        System.Threading.Tasks.Task SnippetsUsernameEncodedIdNodeIdFilesPathGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("path")]string path, [AliasAs("node_id")]string node_id, [AliasAs("encoded_id")]string encoded_id);
        ...
        /// <param name="username"></param>
        /// <param name="encoded_id">The snippet&#39;s id.</param>
        /// <param name="node_id">A commit revision (SHA1).</param>
        /// <returns>Task of Snippet</returns>
        [Get("/snippets/{username}/{encoded_id}/{node_id}")]
        System.Threading.Tasks.Task<Snippet> SnippetsUsernameEncodedIdNodeIdGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("encoded_id")]string encoded_id, [AliasAs("node_id")]string node_id);
        ...
        System.Threading.Tasks.Task<Snippet> SnippetsUsernameEncodedIdNodeIdPut([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("encoded_id")]string encoded_id, [AliasAs("node_id")]string node_id);
        ...
        System.Threading.Tasks.Task<Snippet> SnippetsUsernameEncodedIdPut([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("encoded_id")]string encoded_id);
        ...
        /// <exception cref="Itofinity.Bitbucket.Rest.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="username"></param>
        /// <param name="encoded_id">The snippet id.</param>
        /// <param name="revision">A revspec expression. This can simply be a commit SHA1, a ref name, or a compare expression like &#x60;staging..production&#x60;.</param>
        /// <param name="path">When used, only one the diff of the specified file will be returned. (optional)</param>
        /// <returns>Task of void</returns>
        [Get("/snippets/{username}/{encoded_id}/{revision}/diff")]
        System.Threading.Tasks.Task SnippetsUsernameEncodedIdRevisionDiffGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("encoded_id")]string encoded_id, [AliasAs("revision")]string revision, [AliasAs("path")]string path = null);
        ...
        System.Threading.Tasks.Task SnippetsUsernameEncodedIdRevisionPatchGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("encoded_id")]string encoded_id, [AliasAs("revision")]string revision);
        ...
        System.Threading.Tasks.Task<PaginatedUsers> SnippetsUsernameEncodedIdWatchDelete([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("encoded_id")]string encoded_id);
        ...
        System.Threading.Tasks.Task<PaginatedUsers> SnippetsUsernameEncodedIdWatchGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("encoded_id")]string encoded_id);
        ...
        System.Threading.Tasks.Task<PaginatedUsers> SnippetsUsernameEncodedIdWatchPut([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("encoded_id")]string encoded_id);
        ...
        System.Threading.Tasks.Task<PaginatedUsers> SnippetsUsernameEncodedIdWatchersGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("encoded_id")]string encoded_id);
        ...
        /// </remarks>
        /// <exception cref="Itofinity.Bitbucket.Rest.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="username">Limits the result to snippets owned by this user.</param>
        /// <param name="role">Filter down the result based on the authenticated user&#39;s role (&#x60;owner&#x60;, &#x60;contributor&#x60;, or &#x60;member&#x60;). (optional)</param>
        /// <returns>Task of PaginatedSnippets</returns>
        [Get("/snippets/{username}")]
        System.Threading.Tasks.Task<PaginatedSnippets> SnippetsUsernameGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("role")]string role = null);
        ...
        System.Threading.Tasks.Task<Snippet> SnippetsUsernamePost([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [Body]Snippet _body);
