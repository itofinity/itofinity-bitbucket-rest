...
namespace Itofinity.Bitbucket.Rest.Api
{
    ...
    public interface IRepositoriesApi
    {
        ...
        /// <param name="after">Filter the results to include only repositories create on or after this [ISO-8601](https://en.wikipedia.org/wiki/ISO_8601)  timestamp. Example: &#x60;YYYY-MM-DDTHH:mm:ss.sssZ&#x60; (optional)</param>
        /// <returns>Task of PaginatedRepositories</returns>
        [Get("/repositories")]
        System.Threading.Tasks.Task<PaginatedRepositories> RepositoriesGet([Header("UserAgent")] string userAgent, [AliasAs("after")]string after = null);
        ...
        /// <param name="role"> Filters the result based on the authenticated user&#39;s role on each repository.  * **member**: returns repositories to which the user has explicit read access * **contributor**: returns repositories to which the user has explicit write access * **admin**: returns repositories to which the user has explicit administrator access * **owner**: returns all repositories owned by the current user  (optional)</param>
        /// <returns>Task of PaginatedRepositories</returns>
        [Get("/repositories/{username}")]
        System.Threading.Tasks.Task<PaginatedRepositories> RepositoriesUsernameGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("role")]string role = null);
        ...
        /// <param name="username">This can either be the username or the UUID of the account, surrounded by curly-braces, for example: &#x60;{account UUID}&#x60;. An account is either a team or user. </param>
        /// <param name="repo_slug">This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: &#x60;{repository UUID}&#x60;. </param>
        /// <param name="redirect_to">If a repository has been moved to a new location, use this parameter to show users a friendly message in the Bitbucket UI that the repository has moved to a new location. However, a GET to this endpoint will still return a 404.  (optional)</param>
        /// <returns>Task of void</returns>
        [Delete("/repositories/{username}/{repo_slug}")]
        System.Threading.Tasks.Task RepositoriesUsernameRepoSlugDelete([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("repo_slug")]string repo_slug, [AliasAs("redirect_to")]string redirect_to = null);
        ...
        /// <param name="renames"> When &#x60;true&#x60;, Bitbucket will follow the history of the file across renames (this is the default behavior). This can be turned off by specifying &#x60;false&#x60;. (optional)</param>
        ...
        /// <returns>Task of PaginatedFiles</returns>
        [Get("/repositories/{username}/{repo_slug}/filehistory/{node}/{path}")]
        System.Threading.Tasks.Task<PaginatedFiles> RepositoriesUsernameRepoSlugFilehistoryNodePathGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("node")]string node, [AliasAs("path")]string path, [AliasAs("repo_slug")]string repo_slug, [AliasAs("renames")]string renames = null, [AliasAs("q")]string q = null, [AliasAs("sort")]string sort = null);
        ...
        System.Threading.Tasks.Task<PaginatedRepositories> RepositoriesUsernameRepoSlugForksGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("repo_slug")]string repo_slug);
        ...
        /// <param name="username">This can either be the username or the UUID of the account, surrounded by curly-braces, for example: &#x60;{account UUID}&#x60;. An account is either a team or user. </param>
        /// <param name="repo_slug">This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: &#x60;{repository UUID}&#x60;. </param>
        /// <param name="_body">A repository object. This can be left blank. (optional)</param>
        /// <returns>Task of Repository</returns>
        [Post("/repositories/{username}/{repo_slug}/forks")]
        System.Threading.Tasks.Task<Repository> RepositoriesUsernameRepoSlugForksPost([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("repo_slug")]string repo_slug, [Body]Repository _body = null);
        ...
        System.Threading.Tasks.Task<Repository> RepositoriesUsernameRepoSlugGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("repo_slug")]string repo_slug);
        ...
        /// <param name="username">This can either be the username or the UUID of the account, surrounded by curly-braces, for example: &#x60;{account UUID}&#x60;. An account is either a team or user. </param>
        /// <param name="repo_slug">This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: &#x60;{repository UUID}&#x60;. </param>
        /// <param name="_body">The repository that is to be created. Note that most object elements are optional. Elements \&quot;owner\&quot; and \&quot;full_name\&quot; are ignored as the URL implies them. (optional)</param>
        /// <returns>Task of Repository</returns>
        [Post("/repositories/{username}/{repo_slug}")]
        System.Threading.Tasks.Task<Repository> RepositoriesUsernameRepoSlugPost([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("repo_slug")]string repo_slug, [Body]Repository _body = null);
        ...
        /// <param name="username">This can either be the username or the UUID of the account, surrounded by curly-braces, for example: &#x60;{account UUID}&#x60;. An account is either a team or user. </param>
        /// <param name="repo_slug">This can either be the repository slug or the UUID of the repository, surrounded by curly-braces, for example: &#x60;{repository UUID}&#x60;. </param>
        /// <param name="_body">The repository that is to be updated.  Note that the elements \&quot;owner\&quot; and \&quot;full_name\&quot; are ignored since the URL implies them.  (optional)</param>
        /// <returns>Task of Repository</returns>
        [Put("/repositories/{username}/{repo_slug}")]
        System.Threading.Tasks.Task<Repository> RepositoriesUsernameRepoSlugPut([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("repo_slug")]string repo_slug, [Body]Repository _body = null);
        ...
        /// <param name="username"></param>
        /// <param name="repo_slug"></param>
        /// <param name="format">Instead of returning the file&#39;s contents, return the (json) meta data for it. (optional)</param>
        /// <returns>Task of PaginatedTreeentries</returns>
        [Get("/repositories/{username}/{repo_slug}/src")]
        System.Threading.Tasks.Task<PaginatedTreeentries> RepositoriesUsernameRepoSlugSrcGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("repo_slug")]string repo_slug, [AliasAs("format")]string format = null);
        ...
        /// <param name="path"></param>
        /// <param name="repo_slug"></param>
        /// <param name="format">If &#39;meta&#39; is provided, returns the (json) meta data for the contents of the file.  If &#39;rendered&#39; is provided, returns the contents of a non-binary file in HTML-formatted rendered markup. Since Git and Mercurial do not generally track what text encoding scheme is used, this endpoint attempts to detect the most appropriate character encoding. While usually correct, determining the character encoding can be ambiguous which in exceptional cases can lead to misinterpretation of the characters. As such, the raw element in the response object should not be treated as equivalent to the file&#39;s actual contents. (optional)</param>
        /// <param name="q">Optional filter expression as per [filtering and sorting](../../../../../../meta/filtering). (optional)</param>
        /// <param name="sort">Optional sorting parameter as per [filtering and sorting](../../../../../../meta/filtering#query-sort). (optional)</param>
        /// <returns>Task of PaginatedTreeentries</returns>
        [Get("/repositories/{username}/{repo_slug}/src/{node}/{path}")]
        System.Threading.Tasks.Task<PaginatedTreeentries> RepositoriesUsernameRepoSlugSrcNodePathGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("node")]string node, [AliasAs("path")]string path, [AliasAs("repo_slug")]string repo_slug, [AliasAs("format")]string format = null, [AliasAs("q")]string q = null, [AliasAs("sort")]string sort = null);
        ...
        System.Threading.Tasks.Task RepositoriesUsernameRepoSlugWatchersGet([Header("UserAgent")] string userAgent, [AliasAs("username")]string username, [AliasAs("repo_slug")]string repo_slug);
        ...
        System.Threading.Tasks.Task<PaginatedRepositoryPermissions> UserPermissionsRepositoriesGet([Header("UserAgent")] string userAgent, [AliasAs("q")]string q = null, [AliasAs("sort")]string sort = null);
