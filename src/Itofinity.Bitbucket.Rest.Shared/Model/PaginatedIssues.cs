...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedIssues :  IEquatable<PaginatedIssues>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedIssues" /> class.
        /// </summary>
        ...
        public PaginatedIssues(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<Issue> Values = default(List<Issue>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedIssues);
        }

        /// <summary>
        /// Returns true if PaginatedIssues instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedIssues to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedIssues other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
