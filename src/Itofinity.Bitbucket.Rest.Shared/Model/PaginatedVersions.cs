...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedVersions :  IEquatable<PaginatedVersions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedVersions" /> class.
        /// </summary>
        ...
        public PaginatedVersions(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<ModelVersion> Values = default(List<ModelVersion>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedVersions);
        }

        /// <summary>
        /// Returns true if PaginatedVersions instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedVersions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedVersions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
