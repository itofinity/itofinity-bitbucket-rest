...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedTags :  IEquatable<PaginatedTags>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedTags" /> class.
        /// </summary>
        ...
        public PaginatedTags(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<Tag> Values = default(List<Tag>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedTags);
        }

        /// <summary>
        /// Returns true if PaginatedTags instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedTags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedTags other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
