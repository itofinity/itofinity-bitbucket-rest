...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedCommitComments :  IEquatable<PaginatedCommitComments>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedCommitComments" /> class.
        /// </summary>
        ...
        public PaginatedCommitComments(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<CommitComment> Values = default(List<CommitComment>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<CommitComment> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedCommitComments);
        }

        /// <summary>
        /// Returns true if PaginatedCommitComments instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedCommitComments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedCommitComments other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
