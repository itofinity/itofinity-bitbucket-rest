...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Account : ModelObject,  IEquatable<Account>, IValidatableObject
    {
        /// <summary>
