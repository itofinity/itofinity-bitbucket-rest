...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedIssueAttachments :  IEquatable<PaginatedIssueAttachments>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedIssueAttachments" /> class.
        /// </summary>
        ...
        public PaginatedIssueAttachments(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<IssueAttachment> Values = default(List<IssueAttachment>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<IssueAttachment> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedIssueAttachments);
        }

        /// <summary>
        /// Returns true if PaginatedIssueAttachments instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedIssueAttachments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedIssueAttachments other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
