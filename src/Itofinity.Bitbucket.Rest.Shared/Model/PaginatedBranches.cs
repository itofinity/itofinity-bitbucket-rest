...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedBranches :  IEquatable<PaginatedBranches>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedBranches" /> class.
        /// </summary>
        ...
        public PaginatedBranches(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<Branch> Values = default(List<Branch>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedBranches);
        }

        /// <summary>
        /// Returns true if PaginatedBranches instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedBranches to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedBranches other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
