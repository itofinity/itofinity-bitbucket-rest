...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedLogEntries :  IEquatable<PaginatedLogEntries>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedLogEntries" /> class.
        /// </summary>
        ...
        public PaginatedLogEntries(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<IssueChange> Values = default(List<IssueChange>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<IssueChange> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedLogEntries);
        }

        /// <summary>
        /// Returns true if PaginatedLogEntries instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedLogEntries to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedLogEntries other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
