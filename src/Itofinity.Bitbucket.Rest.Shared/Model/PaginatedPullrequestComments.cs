...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedPullrequestComments :  IEquatable<PaginatedPullrequestComments>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedPullrequestComments" /> class.
        /// </summary>
        ...
        public PaginatedPullrequestComments(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<PullrequestComment> Values = default(List<PullrequestComment>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<PullrequestComment> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedPullrequestComments);
        }

        /// <summary>
        /// Returns true if PaginatedPullrequestComments instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedPullrequestComments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedPullrequestComments other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
