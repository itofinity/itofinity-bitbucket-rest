...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedIssueComments :  IEquatable<PaginatedIssueComments>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedIssueComments" /> class.
        /// </summary>
        ...
        public PaginatedIssueComments(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<IssueComment> Values = default(List<IssueComment>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<IssueComment> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedIssueComments);
        }

        /// <summary>
        /// Returns true if PaginatedIssueComments instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedIssueComments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedIssueComments other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
