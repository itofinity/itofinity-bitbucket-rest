...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedDiffstats :  IEquatable<PaginatedDiffstats>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedDiffstats" /> class.
        /// </summary>
        ...
        public PaginatedDiffstats(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<Diffstat> Values = default(List<Diffstat>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<Diffstat> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedDiffstats);
        }

        /// <summary>
        /// Returns true if PaginatedDiffstats instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedDiffstats to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedDiffstats other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
