...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    public partial class Page :  IEquatable<Page>, IValidatableObject
    {
        ...
        /// <param name="_Page">Page number of the current results. This is an optional element that is not provided in all responses..</param>
        ...
        public Page(int? Size = default(int?), int? _Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string))
        {
            this.Size = Size;
            this._Page = _Page;
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._Page != null)
                    hash = hash * 59 + this._Page.GetHashCode();
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this._Page < (int?)1)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for _Page, must be a value greater than or equal to 1.", new [] { "_Page" });
            }
