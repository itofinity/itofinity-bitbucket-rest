...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedComponents :  IEquatable<PaginatedComponents>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedComponents" /> class.
        /// </summary>
        ...
        public PaginatedComponents(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<Component> Values = default(List<Component>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<Component> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedComponents);
        }

        /// <summary>
        /// Returns true if PaginatedComponents instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedComponents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedComponents other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
