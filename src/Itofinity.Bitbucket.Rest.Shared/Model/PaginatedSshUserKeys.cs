...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedSshUserKeys :  IEquatable<PaginatedSshUserKeys>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedSshUserKeys" /> class.
        /// </summary>
        ...
        public PaginatedSshUserKeys(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<SshAccountKey> Values = default(List<SshAccountKey>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<SshAccountKey> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedSshUserKeys);
        }

        /// <summary>
        /// Returns true if PaginatedSshUserKeys instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedSshUserKeys to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedSshUserKeys other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
