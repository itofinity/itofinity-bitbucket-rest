...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedUsers :  IEquatable<PaginatedUsers>, IValidatableObject
    {
        /// <summary>
        ...
        public PaginatedUsers(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<User> Values = default(List<User>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedUsers);
        }

        /// <summary>
        /// Returns true if PaginatedUsers instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedUsers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedUsers other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
