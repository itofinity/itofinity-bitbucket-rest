...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedHookEvents :  IEquatable<PaginatedHookEvents>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedHookEvents" /> class.
        /// </summary>
        ...
        public PaginatedHookEvents(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<HookEvent> Values = default(List<HookEvent>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<HookEvent> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedHookEvents);
        }

        /// <summary>
        /// Returns true if PaginatedHookEvents instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedHookEvents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedHookEvents other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
