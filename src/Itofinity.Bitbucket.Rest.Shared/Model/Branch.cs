...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    public partial class Branch :  IEquatable<Branch>, IValidatableObject
    {
        ...
        public Branch(string Type = default(string), RefLinks Links = default(RefLinks), string Name = default(string), Commit Target = default(Commit))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for Branch and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as Branch);
        }
