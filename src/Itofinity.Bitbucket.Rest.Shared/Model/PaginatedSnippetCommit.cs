...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedSnippetCommit :  IEquatable<PaginatedSnippetCommit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedSnippetCommit" /> class.
        /// </summary>
        ...
        public PaginatedSnippetCommit(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<SnippetCommit> Values = default(List<SnippetCommit>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<SnippetCommit> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedSnippetCommit);
        }

        /// <summary>
        /// Returns true if PaginatedSnippetCommit instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedSnippetCommit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedSnippetCommit other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
