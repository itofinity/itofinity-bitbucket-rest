...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedMilestones :  IEquatable<PaginatedMilestones>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedMilestones" /> class.
        /// </summary>
        ...
        public PaginatedMilestones(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<Milestone> Values = default(List<Milestone>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedMilestones);
        }

        /// <summary>
        /// Returns true if PaginatedMilestones instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedMilestones to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedMilestones other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
