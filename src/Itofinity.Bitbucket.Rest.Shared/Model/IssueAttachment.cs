...
namespace Itofinity.Bitbucket.Rest.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IssueAttachment : ModelObject,  IEquatable<IssueAttachment>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IssueAttachment);
        }

        /// <summary>
        /// Returns true if IssueAttachment instances are equal
        /// </summary>
        /// <param name="other">Instance of IssueAttachment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IssueAttachment other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
