...
{
    /// <summary>
    /// A paginated list of email addresses.
    /// </summary>
    [DataContract]
    public partial class PaginatedEmailAddresses :  IEquatable<PaginatedEmailAddresses>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedEmailAddresses" /> class.
        /// </summary>
        ...
        public PaginatedEmailAddresses(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<EmailAddress> Values = default(List<EmailAddress>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<EmailAddress> Values { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PaginatedEmailAddresses {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedEmailAddresses);
        }

        /// <summary>
        /// Returns true if PaginatedEmailAddresses instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedEmailAddresses to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedEmailAddresses other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
