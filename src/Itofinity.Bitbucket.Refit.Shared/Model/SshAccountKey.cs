...
namespace Itofinity.Bitbucket.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SshAccountKey : SshKey,  IEquatable<SshAccountKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SshAccountKey" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SshAccountKey() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SshAccountKey" /> class.
        /// </summary>
        ...
        public SshAccountKey(string Type = default(string), string Uuid = default(string), string Key = default(string), string Comment = default(string), string Label = default(string), DateTime? CreatedOn = default(DateTime?), DateTime? LastUsed = default(DateTime?), EmailAddressLinks Links = default(EmailAddressLinks), Account Owner = default(Account))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for SshAccountKey and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SshAccountKey);
        }

        /// <summary>
        /// Returns true if SshAccountKey instances are equal
        /// </summary>
        /// <param name="other">Instance of SshAccountKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SshAccountKey other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
