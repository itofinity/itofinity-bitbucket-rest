...
namespace Itofinity.Bitbucket.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SnippetCommitLinks :  IEquatable<SnippetCommitLinks>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SnippetCommitLinks);
        }

        /// <summary>
        /// Returns true if SnippetCommitLinks instances are equal
        /// </summary>
        /// <param name="other">Instance of SnippetCommitLinks to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SnippetCommitLinks other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
