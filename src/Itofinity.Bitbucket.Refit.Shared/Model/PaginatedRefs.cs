...
namespace Itofinity.Bitbucket.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedRefs :  IEquatable<PaginatedRefs>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedRefs" /> class.
        /// </summary>
        ...
        public PaginatedRefs(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<ModelRef> Values = default(List<ModelRef>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<ModelRef> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedRefs);
        }

        /// <summary>
        /// Returns true if PaginatedRefs instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedRefs to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedRefs other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
