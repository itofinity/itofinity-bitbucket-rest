...
namespace Itofinity.Bitbucket.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedPullrequests :  IEquatable<PaginatedPullrequests>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedPullrequests" /> class.
        /// </summary>
        ...
        public PaginatedPullrequests(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<Pullrequest> Values = default(List<Pullrequest>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedPullrequests);
        }

        /// <summary>
        /// Returns true if PaginatedPullrequests instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedPullrequests to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedPullrequests other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
