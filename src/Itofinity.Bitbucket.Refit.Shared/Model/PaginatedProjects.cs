...
namespace Itofinity.Bitbucket.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedProjects :  IEquatable<PaginatedProjects>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedProjects" /> class.
        /// </summary>
        ...
        public PaginatedProjects(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<Project> Values = default(List<Project>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedProjects);
        }

        /// <summary>
        /// Returns true if PaginatedProjects instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedProjects to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedProjects other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
