...
namespace Itofinity.Bitbucket.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedSnippetComments :  IEquatable<PaginatedSnippetComments>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedSnippetComments" /> class.
        /// </summary>
        ...
        public PaginatedSnippetComments(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<SnippetComment> Values = default(List<SnippetComment>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<SnippetComment> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedSnippetComments);
        }

        /// <summary>
        /// Returns true if PaginatedSnippetComments instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedSnippetComments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedSnippetComments other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
