...
namespace Itofinity.Bitbucket.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedSnippets :  IEquatable<PaginatedSnippets>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedSnippets" /> class.
        /// </summary>
        ...
        public PaginatedSnippets(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<Snippet> Values = default(List<Snippet>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<Snippet> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedSnippets);
        }

        /// <summary>
        /// Returns true if PaginatedSnippets instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedSnippets to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedSnippets other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
