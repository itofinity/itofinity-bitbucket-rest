...
namespace Itofinity.Bitbucket.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedTeamPermissions :  IEquatable<PaginatedTeamPermissions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedTeamPermissions" /> class.
        /// </summary>
        ...
        public PaginatedTeamPermissions(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<TeamPermission> Values = default(List<TeamPermission>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<TeamPermission> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedTeamPermissions);
        }

        /// <summary>
        /// Returns true if PaginatedTeamPermissions instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedTeamPermissions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedTeamPermissions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
