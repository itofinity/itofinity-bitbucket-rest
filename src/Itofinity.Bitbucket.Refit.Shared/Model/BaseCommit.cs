...
namespace Itofinity.Bitbucket.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BaseCommit : ModelObject,  IEquatable<BaseCommit>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BaseCommit" /> class.
        /// </summary>
        ...
        public BaseCommit(string Type = default(string), string Hash = default(string), DateTime? Date = default(DateTime?), Author Author = default(Author), string Message = default(string), CommentContent Summary = default(CommentContent), List<BaseCommit> Parents = default(List<BaseCommit>))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for BaseCommit and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as BaseCommit);
        }

        /// <summary>
        /// Returns true if BaseCommit instances are equal
        /// </summary>
        /// <param name="other">Instance of BaseCommit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BaseCommit other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
