...
namespace Itofinity.Bitbucket.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CommitComment : Comment,  IEquatable<CommitComment>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommitComment" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CommitComment() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CommitComment" /> class.
        /// </summary>
        ...
        public CommitComment(string Type = default(string), int? Id = default(int?), DateTime? CreatedOn = default(DateTime?), DateTime? UpdatedOn = default(DateTime?), CommentContent Content = default(CommentContent), User User = default(User), bool? Deleted = default(bool?), Comment Parent = default(Comment), CommentInline Inline = default(CommentInline), CommentLinks Links = default(CommentLinks), Commit Commit = default(Commit))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for CommitComment and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CommitComment);
        }

        /// <summary>
        /// Returns true if CommitComment instances are equal
        /// </summary>
        /// <param name="other">Instance of CommitComment to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommitComment other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
