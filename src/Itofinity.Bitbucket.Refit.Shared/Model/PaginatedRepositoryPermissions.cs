...
namespace Itofinity.Bitbucket.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedRepositoryPermissions :  IEquatable<PaginatedRepositoryPermissions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedRepositoryPermissions" /> class.
        /// </summary>
        ...
        public PaginatedRepositoryPermissions(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<RepositoryPermission> Values = default(List<RepositoryPermission>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<RepositoryPermission> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedRepositoryPermissions);
        }

        /// <summary>
        /// Returns true if PaginatedRepositoryPermissions instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedRepositoryPermissions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedRepositoryPermissions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
