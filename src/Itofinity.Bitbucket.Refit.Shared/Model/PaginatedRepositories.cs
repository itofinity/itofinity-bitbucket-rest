...
namespace Itofinity.Bitbucket.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedRepositories :  IEquatable<PaginatedRepositories>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedRepositories" /> class.
        /// </summary>
        ...
        public PaginatedRepositories(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<Repository> Values = default(List<Repository>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedRepositories);
        }

        /// <summary>
        /// Returns true if PaginatedRepositories instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedRepositories to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedRepositories other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
