...
namespace Itofinity.Bitbucket.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedFiles :  IEquatable<PaginatedFiles>, IValidatableObject
    {
        /// <summary>
        ...
        public PaginatedFiles(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<CommitFile> Values = default(List<CommitFile>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<CommitFile> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedFiles);
        }

        /// <summary>
        /// Returns true if PaginatedFiles instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedFiles to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedFiles other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
