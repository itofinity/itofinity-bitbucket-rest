...
namespace Itofinity.Bitbucket.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Comment : ModelObject,  IEquatable<Comment>, IValidatableObject
    {
        /// <summary>
        ...
        public Comment(string Type = default(string), int? Id = default(int?), DateTime? CreatedOn = default(DateTime?), DateTime? UpdatedOn = default(DateTime?), CommentContent Content = default(CommentContent), User User = default(User), bool? Deleted = default(bool?), Comment Parent = default(Comment), CommentInline Inline = default(CommentInline), CommentLinks Links = default(CommentLinks))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for Comment and cannot be null");
            }
            else
            {
                this.Type = Type;
