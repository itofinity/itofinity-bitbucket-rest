...
namespace Itofinity.Bitbucket.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedTeams :  IEquatable<PaginatedTeams>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedTeams" /> class.
        /// </summary>
        ...
        public PaginatedTeams(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<Team> Values = default(List<Team>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<Team> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedTeams);
        }

        /// <summary>
        /// Returns true if PaginatedTeams instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedTeams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedTeams other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
