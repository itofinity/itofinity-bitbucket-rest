...
namespace Itofinity.Bitbucket.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedWebhookSubscriptions :  IEquatable<PaginatedWebhookSubscriptions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedWebhookSubscriptions" /> class.
        /// </summary>
        ...
        public PaginatedWebhookSubscriptions(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<WebhookSubscription> Values = default(List<WebhookSubscription>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<WebhookSubscription> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedWebhookSubscriptions);
        }

        /// <summary>
        /// Returns true if PaginatedWebhookSubscriptions instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedWebhookSubscriptions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedWebhookSubscriptions other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
