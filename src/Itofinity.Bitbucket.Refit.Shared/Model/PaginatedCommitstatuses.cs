...
namespace Itofinity.Bitbucket.Refit.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaginatedCommitstatuses :  IEquatable<PaginatedCommitstatuses>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaginatedCommitstatuses" /> class.
        /// </summary>
        ...
        public PaginatedCommitstatuses(int? Size = default(int?), int? Page = default(int?), int? Pagelen = default(int?), string Next = default(string), string Previous = default(string), List<Commitstatus> Values = default(List<Commitstatus>))
        {
            this.Size = Size;
            this.Page = Page;
        ...
        public List<Commitstatus> Values { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaginatedCommitstatuses);
        }

        /// <summary>
        /// Returns true if PaginatedCommitstatuses instances are equal
        /// </summary>
        /// <param name="other">Instance of PaginatedCommitstatuses to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaginatedCommitstatuses other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
